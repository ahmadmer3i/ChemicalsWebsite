                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-heading">
                            <h1 class="banner-title">{{$subcategory->name}}</h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item"><a href="{{route('products')}}">Products</a></li>
                                    <li class="breadcrumb-item"><a
                                            href="{{route('product-details', $subcategory->product_category->id)}}">{{$subcategory->product_category->name}}</a>
                                    </li>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12">
                    <div class="sidebar sidebar-left">
                            ...
                            <ul class="nav service-menu">
                                @foreach($subcategory->product_category->product_subcategory as $sub)
                                    <li class="{{request()->is('product-subcategory-details/'.$sub->id) ? 'active' : ''}}">
                                        <a
                                            href="{{route('product-subcategory-details', $sub->id)}}">{{ $sub->name }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div><!-- Widget end -->
                        ...
                        {{--                                --}}{{--                                         src="{{asset('frontend/images/clients/testimonial1.png')}}"--}}
                        {{--                                --}}{{--                                         alt="testimonial">--}}
                ...
                <div class="col-xl-8 col-lg-8">
                    <div class="content-inner-page">
                        ...
                        <h2 class="column-title mrt-0">{{$subcategory->name}}</h2>
