        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto align-items-lg-center">
                <li class="nav-item mx-2">
                    <!-- Link--><a class="nav-link text-uppercase {{request()->is('/')  ? 'active' : ''}}"
                                   href="{{ route('home') }}">Home</a>
                </li>
                <li class="nav-item mx-2">
                    <!-- Link--><a class="nav-link text-uppercase {{request()->is('about')  ? 'active' : ''}}"
                                   href="{{ route('about') }}">About</a>
                </li>
                <li class="nav-item mx-2">
                    <!-- Link--><a class="nav-link text-uppercase {{request()->is('news')  ? 'active' : ''}}"
                                   href="{{ route('news') }}">News</a>
                </li>
                <li class="nav-item mx-2">
                    <!-- Link-->
                    <a class="nav-link text-uppercase {{request()->is('products')  ? 'active' : ''}}"
                ...
                <!--                </li>-->
                <li class="nav-item mx-2">
                    <a class="nav-link text-uppercase {{request()->is('contacts')  ? 'active' : ''}}"
