<header class="header navbar fixed-top navbar-expand-sm">
        ...
        <li class="nav-item dropdown language-dropdown ml-1  ml-lg-0">
            <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="flagDropdown" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false">
                <img src="{{asset('backend/assets/img/ca.svg')}}" alt=""> <span class="d-lg-inline-block d-none"></span>
            </a>
            <div class="dropdown-menu position-absolute" aria-labelledby="flagDropdown">
                <a class="dropdown-item" href="javascript:void(0);"><img src="{{asset('backend/assets/img/de.svg')}}"
                                                                         class="flag-width"
                                                                         alt=""> &#xA0;German</a>
                <a class="dropdown-item" href="javascript:void(0);"><img src="{{asset('backend/assets/img/jp.svg')}}"
                                                                         class="flag-width"
                                                                         alt=""> &#xA0;Japanese</a>
                <a class="dropdown-item" href="javascript:void(0);"><img src="{{asset('backend/assets/img/fr.svg')}}"
                                                                         class="flag-width"
                                                                         alt=""> &#xA0;French</a>
                <a class="dropdown-item" href="javascript:void(0);"><img src="{{asset('backend/assets/img/ru.svg')}}"
                                                                         class="flag-width"
                                                                         alt=""> &#xA0;Russian</a>
                <a class="dropdown-item" href="javascript:void(0);"><img src="{{asset('backend/assets/img/ca.svg')}}"
                                                                         class="flag-width"
                                                                         alt=""> &#xA0;English</a>
            </div>
        </li>
                ...
                <a class="dropdown-item" href="javascript:void(0);">
                    <div class="media">
                        <div class="usr-img online mr-3">
                            <img class="usr-img rounded-circle" src="{{asset('backend/assets/img/90x90.jpg')}}"
                ...
                <a class="dropdown-item text-center  p-1" href="javascript:void(0);">
                    ...
                    <div class="notification-list ">
                        ...
                        <div class="notification-item position-relative  mb-3">
                            ...
                            <p><span class="meta-time">1 minute ago</span> . <span class="meta-member-notification">4 members</span>
                            </p>
                            <ul class="list-inline badge-collapsed-img mt-3">
                                <li class="list-inline-item chat-online-usr">
                                    <img src="{{asset('backend/assets/img/90x90.jpg')}}" alt="admin-profile"
                                         class="ml-0">
                                </li>
                                <li class="list-inline-item chat-online-usr">
                                    <img src="{{asset('backend/assets/img/90x90.jpg')}}" alt="admin-profile">
                        ...
                        <div class="notification-item position-relative  mb-3">
                            ...
                            <ul class="list-inline badge-collapsed-img mt-3">
                                <li class="list-inline-item chat-online-usr">
                                    <img alt="admin-profile" src="{{asset('backend/assets/img/90x90.jpg')}}"
                                         class="ml-0">
                                </li>
                                <li class="list-inline-item chat-online-usr">
                                    <img alt="admin-profile" src="{{asset('backend/assets/img/90x90.jpg')}}">
    ...
    <ul class="navbar-nav flex-row ml-lg-auto">
        ...
        <li class="nav-item dropdown app-dropdown  ml-lg-4 mr-lg-2 order-lg-0 order-2">
            <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="appDropdown" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false">
