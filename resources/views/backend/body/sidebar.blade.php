<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        ...
        <a href="{{route('dashboard')}}">
            <img alt="Logo" src="{{asset('frontend/img/logo/logo.png')}}" class="h-50px logo"/>
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div
                ...
                <div data-kt-menu-trigger="click"
                     class="menu-item here {{request()->is('admin/home/sliders') ||  request()->is('admin/home/global-precences')|| request()->is('admin/home/sliders/add') || request()->is('admin/home/general-info') || request()->is('admin/home/home-contact') || request()->is('admin/home/why-choose-us') || request()->is('admin/home/home-video') ? 'show' : '' }} menu-accordion">
