        ...
        <div class="toolbar bg-transparent pt-6 mb-5" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Website Analytics
                    </h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <div data-kt-daterangepicker="true" data-kt-daterangepicker-opens="left"
                         class="btn btn-sm btn-white btn-active-white btn-active-color-primary d-flex align-items-center px-4">
                        <!--begin::Display range-->
                    ...
                    <a href="../../demo1/dist/.html" class="btn btn-sm btn-primary"
                       data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">Add Goal</a>
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
            </div>
                            ...
                            <div class="card-header py-7">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <!--begin::Title-->
                                        <span
                                            class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2">35,568</span>
                                        <!--end::Title-->
                                        <!--begin::Label-->
                            ...
                            <div class="card-header py-7">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <!--begin::Title-->
                                        <span
                                            class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2">2,579</span>
                                        <!--end::Title-->
                                        <!--begin::Label-->
                            ...
                            <div class="card-header py-7">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <!--begin::Title-->
                                        <span
                                            class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2">5,037</span>
                                        <!--end::Title-->
                                        <!--begin::Label-->
                                        <span class="badge badge-success fs-base">
                                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr066.svg-->
                                    ...
                                    <!--end::Heading-->
                                    <!--begin::Description-->
                                    <span class="fs-6 fw-bold text-gray-400">Visits by Social
                                                    Networks</span>
                                    <!--end::Description-->
                                </div>
                                <!--end::Statistics-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div
                                        ...
                                        <div class="me-5">
                                            <!--begin::Title-->
                                            <a href="#"
                                               class="text-gray-800 fw-bolder text-hover-primary fs-6">Dribbble</a>
                                            <!--end::Title-->
                                            <!--begin::Desc-->
                                            <span
                                                class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Community</span>
                                            <!--end::Desc-->
                                        </div>
                                        <!--end::Content-->
                                        <!--begin::Wrapper-->
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <span class="badge badge-success fs-base">
                                                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr066.svg-->
                                                                <span
                                                                    class="svg-icon svg-icon-5 svg-icon-white ms-n1">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div
                                        ...
                                        <div class="me-5">
                                            <!--begin::Title-->
                                            <a href="#"
                                               class="text-gray-800 fw-bolder text-hover-primary fs-6">Linked
                                                In</a>
                                            <!--end::Title-->
                                            <!--begin::Desc-->
                                            <span
                                                class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Social
                                                            Media</span>
                                            <!--end::Desc-->
                                        </div>
                                        <!--end::Content-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div
                                        ...
                                        <div class="me-5">
                                            <!--begin::Title-->
                                            <a href="#"
                                               class="text-gray-800 fw-bolder text-hover-primary fs-6">Slack</a>
                                            <!--end::Title-->
                                            <!--begin::Desc-->
                                            <span
                                                class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Messanger</span>
                                            <!--end::Desc-->
                                        </div>
                                        <!--end::Content-->
                                        <!--begin::Wrapper-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div
                                        ...
                                        <div class="me-5">
                                            <!--begin::Title-->
                                            <a href="#"
                                               class="text-gray-800 fw-bolder text-hover-primary fs-6">YouTube</a>
                                            <!--end::Title-->
                                            <!--begin::Desc-->
                                            <span
                                                class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Video
                                                            Channel</span>
                                            <!--end::Desc-->
                                        </div>
                                        <!--end::Content-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div
                                        ...
                                        <div class="me-5">
                                            <!--begin::Title-->
                                            <a href="#"
                                               class="text-gray-800 fw-bolder text-hover-primary fs-6">Instagram</a>
                                            <!--end::Title-->
                                            <!--begin::Desc-->
                                            <span
                                                class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Social
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder text-gray-800">Top Referral
                                                    Sources</span>
                                    <span class="text-gray-400 pt-1 fw-bold fs-6">Counted in
                                                    Millions</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table
                                        ...
                                        <tr>
                                            <td class="" colspan="2">
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Google</a>
                                            </td>
                                            <td class="pe-0" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-gray-800 fw-bolder fs-6 me-1">1,256</span>
                                                    <span
                                                        class="text-danger min-w-50px d-block text-end fw-bolder fs-6">-935</span>
                                                </div>
                                            </td>
                                            <td class="" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-dark fw-bolder fs-6 me-3">23.63%</span>
                                                    <span
                                                        class="text-danger min-w-60px d-block text-end fw-bolder fs-6">-9.35%</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="" colspan="2">
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Facebook</a>
                                            </td>
                                            <td class="pe-0" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-gray-800 fw-bolder fs-6 me-1">446</span>
                                                    <span
                                                        class="text-danger min-w-50px d-block text-end fw-bolder fs-6">-576</span>
                                                </div>
                                            </td>
                                            <td class="" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-dark fw-bolder fs-6 me-3">12.45%</span>
                                                    <span
                                                        class="text-danger min-w-60px d-block text-end fw-bolder fs-6">-57.02%</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="" colspan="2">
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Bol.com</a>
                                            </td>
                                            <td class="pe-0" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-gray-800 fw-bolder fs-6 me-1">67</span>
                                                    <span
                                                        class="text-success min-w-50px d-block text-end fw-bolder fs-6">+24</span>
                                                </div>
                                            </td>
                                            <td class="" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-dark fw-bolder fs-6 me-3">73.63%</span>
                                                    <span
                                                        class="text-success min-w-60px d-block text-end fw-bolder fs-6">+28.73%</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="" colspan="2">
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Dutchnews.nl</a>
                                            </td>
                                            <td class="pe-0" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-gray-800 fw-bolder fs-6 me-1">2,136</span>
                                                    <span
                                                        class="text-danger min-w-50px d-block text-end fw-bolder fs-6">-1,229</span>
                                                </div>
                                            </td>
                                            <td class="" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-dark fw-bolder fs-6 me-3">3.67%</span>
                                                    <span
                                                        class="text-danger min-w-60px d-block text-end fw-bolder fs-6">-12.29%</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="" colspan="2">
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Stackoverflow</a>
                                            </td>
                                            <td class="pe-0" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-gray-800 fw-bolder fs-6 me-1">945</span>
                                                    <span
                                                        class="text-danger min-w-50px d-block text-end fw-bolder fs-6">-634</span>
                                                </div>
                                            </td>
                                            <td class="" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-dark fw-bolder fs-6 me-3">25.03%</span>
                                                    <span
                                                        class="text-danger min-w-60px d-block text-end fw-bolder fs-6">-9.35%</span>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="" colspan="2">
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Themeforest</a>
                                            </td>
                                            <td class="pe-0" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-gray-800 fw-bolder fs-6 me-1">237</span>
                                                    <span
                                                        class="text-success min-w-50px d-block text-end fw-bolder fs-6">106</span>
                                                </div>
                                            </td>
                                            <td class="" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-dark fw-bolder fs-6 me-3">36.52%</span>
                                                    <span
                                                        class="text-success min-w-60px d-block text-end fw-bolder fs-6">+3.06%</span>
                                                </div>
                                            </td>
                                        </tr>
                                        </tbody>
                    ...
                    <div class="col-xl-6 mb-5 mb-xl-10">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-5">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder text-gray-800">Top Performing
                                                    Pages</span>
                                    <span class="text-gray-400 pt-1 fw-bold fs-6">Counted in
                                                    Millions</span>
                                </h3>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table
                                        ...
                                        <tr>
                                            <td class="" colspan="2">
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Index</a>
                                            </td>
                                            <td class="pe-0" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-gray-800 fw-bolder fs-6">1,256</span>
                                                    <span
                                                        class="text-danger min-w-50px d-block text-end fw-bolder fs-6">-935</span>
                                                </div>
                                            </td>
                                            <td class="" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <span
                                                        class="text-danger min-w-50px d-block text-end fw-bolder fs-6">-1.35</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="" colspan="2">
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Products</a>
                                            </td>
                                            <td class="pe-0" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-gray-800 fw-bolder fs-6">446</span>
                                                    <span
                                                        class="text-danger min-w-50px d-block text-end fw-bolder fs-6">-576</span>
                                                </div>
                                            </td>
                                            <td class="" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <span
                                                        class="text-danger min-w-50px d-block text-end fw-bolder fs-6">0.32</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="" colspan="2">
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">devs.keenthemes.com</a>
                                            </td>
                                            <td class="pe-0" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-gray-800 fw-bolder fs-6">67</span>
                                                    <span
                                                        class="text-success min-w-50px d-block text-end fw-bolder fs-6">+24</span>
                                                </div>
                                            </td>
                                            <td class="" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <span
                                                        class="text-success min-w-50px d-block text-end fw-bolder fs-6">+8.73</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="" colspan="2">
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">studio.keenthemes.com</a>
                                            </td>
                                            <td class="pe-0" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-gray-800 fw-bolder fs-6">2,136</span>
                                                    <span
                                                        class="text-danger min-w-50px d-block text-end fw-bolder fs-6">-1,229</span>
                                                </div>
                                            </td>
                                            <td class="" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <span
                                                        class="text-danger min-w-50px d-block text-end fw-bolder fs-6">-2.29</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="" colspan="2">
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">graphics.keenthemes.com</a>
                                            </td>
                                            <td class="pe-0" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-gray-800 fw-bolder fs-6">945</span>
                                                    <span
                                                        class="text-danger min-w-50px d-block text-end fw-bolder fs-6">-634</span>
                                                </div>
                                            </td>
                                            <td class="" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <span
                                                        class="text-danger min-w-50px d-block text-end fw-bolder fs-6">-0.35</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="" colspan="2">
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Licenses</a>
                                            </td>
                                            <td class="pe-0" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-gray-800 fw-bolder fs-6">237</span>
                                                    <span
                                                        class="text-success min-w-50px d-block text-end fw-bolder fs-6">106</span>
                                                </div>
                                            </td>
                                            <td class="" colspan="2">
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <span
                                                        class="text-success min-w-50px d-block text-end fw-bolder fs-6">+3.06</span>
                                                </div>
                                            </td>
                                        </tr>
                                        </tbody>
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <span class="text-gray-400 pt-2 fw-bold fs-6">Statistics by
                                                    Countries</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                                    ...
                                    <!--begin::Menu-->
                                    <div
                                        class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold w-100px py-4"
                                        data-kt-menu="true">
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                            ...
                            <div class="card-body pt-5">
                                ...
                                <div id="kt_charts_widget_15_chart"
                                     class="min-h-auto ps-4 pe-6 mb-3 h-300px"></div>
                                <!--end::Chart container-->
                            </div>
                            <!--end::Body-->
                        </div>
                    ...
                    <div class="col-xl-6 mb-5 mb-xl-10">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-5">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder text-gray-800">Top Queries by
                                                    Clicks</span>
                                    <span class="text-gray-400 pt-2 fw-bold fs-6">Counted in
                                                    Millions</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                ...
                                <div class="table-responsive mb-n2">
                                    ...
                                    <table class="table table-row-dashed table-row-gray-300 gs-0 gy-4">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#"
                                                   class="text-gray-600 fw-bolder text-hover-primary mb-1 fs-6">Buy
                                                    phone online</a>
                                            </td>
                                            <td class="d-flex align-items-center border-0">
                                                                <span
                                                                    class="fw-bolder text-gray-800 fs-6 me-3">263</span>
                                                <div class="progress rounded-start-0">
                                                    <div class="progress-bar bg-success m-0"
                                                         role="progressbar"
                                                         style="height: 12px;width: 166px"
                                                         aria-valuenow="166" aria-valuemin="0"
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#"
                                                   class="text-gray-600 fw-bolder text-hover-primary mb-1 fs-6">Top
                                                    10 Earbuds</a>
                                            </td>
                                            <td class="d-flex align-items-center border-0">
                                                                <span
                                                                    class="fw-bolder text-gray-800 fs-6 me-3">238</span>
                                                <div class="progress rounded-start-0">
                                                    <div class="progress-bar bg-success m-0"
                                                         role="progressbar"
                                                         style="height: 12px;width: 158px"
                                                         aria-valuenow="158" aria-valuemin="0"
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#"
                                                   class="text-gray-600 fw-bolder text-hover-primary mb-1 fs-6">Cyber
                                                    Monday</a>
                                            </td>
                                            <td class="d-flex align-items-center border-0">
                                                                <span
                                                                    class="fw-bolder text-gray-800 fs-6 me-3">189</span>
                                                <div class="progress rounded-start-0">
                                                    <div class="progress-bar bg-success m-0"
                                                         role="progressbar"
                                                         style="height: 12px;width: 129px"
                                                         aria-valuenow="129" aria-valuemin="0"
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#"
                                                   class="text-gray-600 fw-bolder text-hover-primary mb-1 fs-6">OLED
                                                    TV in Amsterdam</a>
                                            </td>
                                            <td class="d-flex align-items-center border-0">
                                                                <span
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#"
                                                   class="text-gray-600 fw-bolder text-hover-primary mb-1 fs-6">Macbook
                                                    M1</a>
                                            </td>
                                            <td class="d-flex align-items-center border-0">
                                                                <span
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#"
                                                   class="text-gray-600 fw-bolder text-hover-primary mb-1 fs-6">Best
                            ...
                            <div class="card-header py-7">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <!--begin::Title-->
                                        <span
                                            class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2">7,9</span>
                                        <!--end::Title-->
                                        <!--begin::Label-->
                                        <span class="badge badge-success fs-base">
                                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr066.svg-->
                        ...
                        <div class="card card-flush overflow-hidden h-xl-100">
                            ...
                            <div class="card-header py-5">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <span class="text-gray-400 mt-1 fw-bold fs-6">Reports by states and
                                                    ganders</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div
                                            ...
                                            <div class="me-5">
                                                <!--begin::Title-->
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary fs-6">Direct
                                                    Source</a>
                                                <!--end::Title-->
                                                <!--begin::Desc-->
                                                <span
                                                    class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Direct
                                                                link clicks</span>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Content-->
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Number-->
                                                <span
                                                    class="text-gray-800 fw-bolder fs-4 me-3">1,067</span>
                                                <!--end::Number-->
                                                <!--begin::Info-->
                                                <!--begin::label-->
                                                <span class="badge badge-success fs-base">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div
                                            ...
                                            <div class="me-5">
                                                <!--begin::Title-->
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary fs-6">Social
                                                    Networks</a>
                                                <!--end::Title-->
                                                <!--begin::Desc-->
                                                <span
                                                    class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">All
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Number-->
                                                <span
                                                    class="text-gray-800 fw-bolder fs-4 me-3">24,588</span>
                                                <!--end::Number-->
                                                <!--begin::Info-->
                                                <!--begin::label-->
                                                <span class="badge badge-success fs-base">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div
                                            ...
                                            <div class="me-5">
                                                <!--begin::Title-->
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary fs-6">Email
                                                    Newsletter</a>
                                                <!--end::Title-->
                                                <!--begin::Desc-->
                                                <span
                                                    class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Mailchimp
                                                                Campaigns</span>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Content-->
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div
                                            ...
                                            <div class="me-5">
                                                <!--begin::Title-->
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary fs-6">Referrals</a>
                                                <!--end::Title-->
                                                <!--begin::Desc-->
                                                <span
                                                    class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Impact
                                                                Radius visits</span>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Content-->
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Number-->
                                                <span
                                                    class="text-gray-800 fw-bolder fs-4 me-3">6,578</span>
                                                <!--end::Number-->
                                                <!--begin::Info-->
                                                <!--begin::label-->
                                                <span class="badge badge-danger fs-base">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div
                                            ...
                                            <div class="me-5">
                                                <!--begin::Title-->
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary fs-6">Other</a>
                                                <!--end::Title-->
                                                <!--begin::Desc-->
                                                <span
                                                    class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Many
                                                                Sources</span>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Content-->
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Number-->
                                                <span
                                                    class="text-gray-800 fw-bolder fs-4 me-3">79,458</span>
                                                <!--end::Number-->
                                                <!--begin::Info-->
                                                <!--begin::label-->
                                                <span class="badge badge-success fs-base">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div
                                            ...
                                            <div class="me-5">
                                                <!--begin::Title-->
                                                <a href="#"
                                                   class="text-gray-800 fw-bolder text-hover-primary fs-6">Rising
                                                    Networks</a>
                                                <!--end::Title-->
                                                <!--begin::Desc-->
                                                <span
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Number-->
                                                <span
                                                    class="text-gray-800 fw-bolder fs-4 me-3">18,047</span>
                                                <!--end::Number-->
                                                <!--begin::Info-->
                                                <!--begin::label-->
                                                <span class="badge badge-success fs-base">
                    ...
                    <div class="col-xl-4 mb-5 mb-xl-0">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7 mb-7">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder text-gray-800">Warephase
                                                    stats</span>
                    ...
                    <div class="col-xl-4 mb-5 mb-xl-0">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7 mb-7">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder text-gray-800">Stats by
                                                    Department</span>
                                    <span class="text-gray-400 mt-1 fw-bold fs-6">8k social
                                                    visitors</span>
                                </h3>
                            ...
                            <div class="card-body d-flex justify-content-between flex-column">
                                ...
                                <div class="d-flex flex-wrap d-grid gap-5 mb-10">
                                    <!--begin::Item-->
                                    <div
                                        class="border-end-dashed border-1 border-gray-300 pe-xxl-7 me-xxl-5">
                                        <!--begin::Statistics-->
                                        <div class="d-flex mb-2">
                                            <span class="fs-4 fw-bold text-gray-400 me-1">$</span>
                                            <span
                                                class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2">8,035</span>
                                        </div>
                                        <!--end::Statistics-->
                                        <!--begin::Description-->
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <!--begin::Currency-->
                                            <span
                                                class="fs-4 fw-bold text-gray-400 align-self-start me-1">$</span>
                                            <!--end::Currency-->
                                            <!--begin::Value-->
                                            <span
                                                class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2">4,684</span>
                                            <!--end::Value-->
                                            <!--begin::Label-->
                                            <span class="badge badge-success fs-base">
                                                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr066.svg-->
