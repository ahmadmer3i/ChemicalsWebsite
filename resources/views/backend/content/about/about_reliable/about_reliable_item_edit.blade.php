        ...
        <div class="container ">
            <div class="page-header">
                <div class="page-title">
                    <h3>Edit About Reliable Item</h3>
                    <div class="crumbs">
                        <ul id="breadcrumbs" class="breadcrumb">
                            ...
                            <li class="active"><a href="#">Edit About Reliable Item</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12 align-left">
                                        <h4>Edit About Reliable Item</h4>
                                    </div>
                                </div>
                            </div>
                            <form action="{{route('about.about-reliable.item.update')}}"
                                    ...
                                    <div class="form-group row mb-4 align-left">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                            <textarea rows="5" name="description" class="form-control"
                                                      id="description"
                                                      placeholder="">{{ !empty($item->description) ? $item->description : '' }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4 align-left">
                                        <label for="title"
