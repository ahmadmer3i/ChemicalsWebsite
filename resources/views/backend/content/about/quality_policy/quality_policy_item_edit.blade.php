        ...
        <div class="container ">
            <div class="page-header">
                <div class="page-title">
                    <h3>Edit Quality Policy Item</h3>
                    <div class="crumbs">
                        <ul id="breadcrumbs" class="breadcrumb">
                            ...
                            <li class="active"><a href="#">Edit Quality Policy Item</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12 align-left">
                                        <h4>Edit Quality Policy Item</h4>
                                    </div>
                                </div>
                            </div>
                            <form action="{{route('about.quality-policy.item.update')}}"
                                    ...
                                    <div class="form-group row mb-4 align-left">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                            <input type="text" name="item" class="form-control"
                                                   id="item"
                                                   placeholder=""
                                                   value="{{ !empty($item->item) ? $item->item:'' }}">
                                        </div>
                                    </div>
