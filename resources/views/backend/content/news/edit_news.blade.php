        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Edit News</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                ...
                <div>
                    <a href="#" data-bs-toggle="modal"
                       data-bs-target="#kt_modal_new_target2" class="btn btn-sm btn-dark"><i
                            class="fa fa-plus fs-8"></i>Add Image</a>
                </div>
                {{--Modal--}}
                            ...
                            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                ...
                                >
                                    ...
                                    <div class="mb-13 text-center">
                                        <!--begin::Title-->
                                        <h1 class="mb-3">Add News Image</h1>
                                        <!--end::Title-->
                                        <!--begin::Description-->
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                            <div class="custom-file mb-4">
                                                <img
                                                    ...
                                                    alt=""
                                                    id="show_image-3" style="height: 200px"
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button type="submit" id="kt_modal_new_target_submit"
                                                class="btn btn-primary">
                                                            <span class="indicator-label">Add Image
                                                            </span>
                                        ...
                                        <script type="text/javascript">
                                            $(document).ready(function () {
                                                $('#image-3').change(function (e) {
                                                    const reader = new FileReader();
                                                    reader.onload = function (e) {
                                                        $('#show_image-3').attr('src', e.target.result);
                                                    }
                            ...
                            <div class="widget-content px-5">
                                <div class="form-group row mb-4 align-left">
                                    <label for="section_title"
                                           class="col-xl-2 col-sm-3 col-sm-2 col-form-label">News Title</label>
                                    <div class="col-xl-10 col-lg-9 col-sm-10">
                                ...
                                <div class="form-group row mb-4 align-left">
                                    ...
                                    <div class="col-xl-10 col-lg-9 col-sm-10">
                                            <textarea rows="5" type="text" name="description" class="form-control"
                                                      id="description"
                                                      placeholder="">{{!empty($news->description) ? $news->description : ''}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-4 align-left">
                                    <label for="description"
                        ...
                        <div class="my-5">
                            <table id="kt_datatable_example_5"
                                ...
                                @foreach($news->news_images as $item)
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td class="justify-content-center"><img src="{{asset($item->image)}}" alt=""
                                        ...
                                        <td style="width: 80px">
                                            ...
                                            <a href="{{route('news.news-image.delete', $item->id)}}"
                                            ...
                                            <div class="modal-content rounded">
                                                ...
                                                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                    ...
                                                    <form
                                                        id="kt_modal_new_target_form"
                                                        class="form"
                                                        action="{{route('news.news-image.update')}}"
                                                        method="post"
                                                        enctype="multipart/form-data"
                                                    >
                                                        @csrf
                                                        ...
                                                        <div class="mb-13 text-center">
                                                            <!--begin::Title-->
                                                            <h1 class="mb-3">Update News Image</h1>
                                                            <!--end::Title-->
                                                            <!--begin::Description-->
                                                            <div class="text-muted fw-bold fs-5">
                                                            </div>
                                                        ...
                                                        <div class="d-flex flex-column mb-8 fv-row">
                                                            ...
                                                            <input type="file" id="image{{$item->id}}"
                                                                   class="form-control form-control-solid"
                                                                   placeholder="Enter Policy Tile" name="image"/>
                                                        </div>
                                                        <div class="form-group row mb-4 align-left pb-5">
                                                            <label for="description"
                                                                   class="col-xl-2 col-sm-3 col-sm-2 col-form-label"></label>
                                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                                <div class="custom-file mb-4">
                                                                    <img
                                                                        src="{{!empty($item->image) ? asset($item->image) : asset('backend/assets/media/holders/750x450.png')}}"
                                                                        alt=""
