            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Home Sliders</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                            ...
                            <table id="kt_datatable_example_5" class="table table-striped gy-5 gs-7 border rounded">
                                ...
                                @foreach($sliders as $slider)
                                    <tr>
                                        ...
                                        <td><img class="img-thumbnail" src="{{asset($slider->image)}}" width="200"></td>
                                        <td style="width: 80px">
                                            <a href="{{route('home.sliders.edit',$slider->id)}}"
                                               data-bs-toggle="modal"
                                               data-bs-target="#kt_modal_new_target2-{{$slider->id}}"
                                    ...
                                    {{-- Modal --}}
                                    <div class="modal fade" id="kt_modal_new_target2-{{$slider->id}}" tabindex="-1"
                                         aria-hidden="true">
                                        <!--begin::Modal dialog-->
								...
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            $('#image{{$slider->id}}').change(function (e) {
                                                const reader = new FileReader();
                                                reader.onload = function (e) {
                                                    $('#show_image{{$slider->id}}').attr('src', e.target.result);
                                                }
                                        ...
                                        >
                                            ...
                                            <div class="d-flex flex-column mb-8 fv-row">
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <img class="img-thumbnail form-control-sm"
                                                         width="400"
                                                         src="{{asset('backend/assets/media/holders/192.1280.png')}}"
                                                         id="show_image">
                                                </div>
                                            </div>
                                            <!--end::Input group-->
