        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Video Section</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Video Section</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                                ...
                                <div class="widget-content px-5">
                                    ...
                                    <div class="form-group row mb-4 align-left pb-5">
                                        <label for="image"
                                               class="col-xl-2 col-sm-3 col-sm-2 col-form-label"></label>
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                            <div class="video-container video mb-5">
                                                <iframe id="show_video"
                                                        src="{{!empty($video_section->video) ? asset($video_section->video) : ''}}"
                                                        allow="autoplay; encrypted-media" allowfullscreen
                                                        style="border: 1px; height:300px; width: 100%">
                                                </iframe>
                                            </div>
                                        </div>
                                    </div>
