                ...
                <div class="page-title">
                    ...
                    <div class="crumbs">
                        <ul id="breadcrumbs" class="breadcrumb">
                            ...
                            <li class="active"><a href="#">Why Choose Us List Add</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12 align-left">
                                        <h4>Why Choose Us List Add</h4>
                                    </div>
                                </div>
                            </div>
                            <form action="{{route('home.why-choose-us.list.store')}}" enctype="multipart/form-data"
                                  method="post">
                                @csrf
