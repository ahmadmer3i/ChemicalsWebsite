!function (t, e) {
    ...
    function T(t, e) {
        var i = Object.assign({}, S, e), n = Array.from(t), s = !1;
        ...
        return Object.keys(i).forEach(function (t) {
            ...
            if (h > 0) {
                ...
                (c = r.every(function (t) {
                    var e = new v(t.left + h, t.top, t.width, t.height, t.id), i = !n.some(function (t) {
    ...
    var N = 0, H = function (e) {
        ...
        return function (t, e) {
            ...
            key: "_init", value: function () {
                ...
                var e = window.getComputedStyle(this.element, null), i = r.getSize(this.element).width;
            ...
            key: "_getFilteredSets", value: function (t, e) {
                var i = this, n = [], s = [];
            ...
            key: "_doesPassFilter", value: function (t, e) {
            ...
            key: "_getColumnSize", value: function (t, e) {
                var i;
            ...
            key: "_setColumns", value: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : r.getSize(this.element).width,
                    e = this._getGutterSize(t), i = this._getColumnSize(t, e), n = (t + e) / i;
            ...
            key: "_getNextPositions", value: function (t) {
                ...
                if (this.options.isCentered) {
                    var i = t.map(function (t, i) {
                        var n = r.getSize(t.element, !0), s = e._getItemPosition(n);
            ...
            key: "add", value: function (t) {
                var e = this, i = O(t).map(function (t) {
                    return new _(t)
                });
                this._initItems(i), this._resetCols();
                var n = T(this._mergeNewItems(i), this.lastSort), s = this._filter(this.lastFilter, n),
                    o = function (t) {
                        return i.includes(t)
                    }, r = function (t) {
            ...
            key: "getSize", value: function (t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                    i = window.getComputedStyle(t, null), n = b(t, "width", i), s = b(t, "height", i);
    ...
    }, H.Classes = y, H.FilterMode = {ANY: "any", ALL: "all"}, H.options = {
        group: H.ALL_ITEMS,
        speed: 250,
